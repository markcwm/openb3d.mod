...
Import "src/3ds.cpp"
Import "src/animation.cpp"
Import "src/animation_keys.cpp"
Import "src/bank.cpp"
Import "src/bone.cpp"
Import "src/brush.cpp"
Import "src/camera.cpp"
Import "src/collision.cpp"
Import "src/collision2.cpp"
Import "src/csg.cpp"
Import "src/entity.cpp"
Import "src/file.cpp"
Import "src/functions.cpp"
Import "src/geom.cpp"
Import "src/geosphere.cpp" ' 0.8
Import "src/global.cpp"
Import "src/light.cpp"
Import "src/material.cpp"
Import "src/maths_helper.cpp"
Import "src/matrix.cpp"
Import "src/md2.cpp" ' 0.9
Import "src/mesh.cpp"
Import "src/metaball.cpp" ' 0.9
Import "src/model.cpp"
Import "src/octree.cpp"
Import "src/particle.cpp" ' 0.9
Import "src/pick.cpp"
Import "src/pivot.cpp"
Import "src/project.cpp"
Import "src/quaternion.cpp"
Import "src/shadow.cpp"
Import "src/sprite.cpp"
Import "src/sprite_batch.cpp"
Import "src/stencil.cpp"
Import "src/string_helper.cpp"
Import "src/surface.cpp"
Import "src/terrain.cpp"
Import "src/texture.cpp"
Import "src/texture_filter.cpp"
Import "src/tilt.cpp"
Import "src/touch.cpp"
Import "src/tree.cpp"
'Import "src/turn.cpp" ' deprecated
Import "src/voxel.cpp"
Import "src/x.cpp"

Import "src/collidetri.c"
Import "src/stb_image.c"
?Not Linux
Import "src/GLee.c" ' 5.4 (not in official src)
?
