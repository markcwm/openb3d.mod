...
While Not KeyDown(KEY_ESCAPE)
	...
	Text 20,40,"0/1/2/3: tex[0] blending, LShift + 0/1/2/3: tex[1] blending"
	Text 20,60,"cube.brush.tex[0].blend="+cube.brush.tex[0].blend[0]+" mesh.surf.brush.tex[0].blend="+brush2.tex[0].blend[0]
	Text 20,80,"cube.brush.tex[1].blend="+cube.brush.tex[1].blend[0]+" mesh.surf.brush.tex[1].blend="+brush2.tex[1].blend[0]
