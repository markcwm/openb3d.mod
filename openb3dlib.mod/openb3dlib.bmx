...
Const GLOBAL_vbo_enabled:Int=		9
Const GLOBAL_vbo_min_tris:Int=		10
Const GLOBAL_Shadows_enabled:Int=	11
Const GLOBAL_anim_speed:Int=		12
Const GLOBAL_fog_enabled:Int=		13
Const GLOBAL_root_ent:Int=			14
Const GLOBAL_camera_in_use:Int=		15
Const GLOBAL_alpha_enable:Int=		16
Const GLOBAL_blend_mode:Int=		17
Const GLOBAL_fx1:Int=				18
Const GLOBAL_fx2:Int=				19
