...
Extern
	...
	Function MatrixQuaternion_FromAngleAxis_( angle:Float,ax:Float,ay:Float,az:Float,rx:Float Ptr,ry:Float Ptr,rz:Float Ptr,rw:Float Ptr )' = "MatrixQuaternion_FromAngleAxis"
	Function MatrixQuaternion_MultiplyQuat_( x1:Float,y1:Float,z1:Float,w1:Float,x2:Float,y2:Float,z2:Float,w2:Float,rx:Float Ptr,ry:Float Ptr,rz:Float Ptr,rw:Float Ptr )' = "MatrixQuaternion_MultiplyQuat"
	Function MatrixInterpolateMatrix_( m:Byte Ptr,a:Byte Ptr,alpha:Float )' = "MatrixInterpolateMatrix"
...
Extern
	...
	Function SetBrushString_( obj:Byte Ptr,varid:Int,cstr:Byte Ptr )' = "SetBrushString"
	...
	Function SetEntityString_( obj:Byte Ptr,varid:Int,cstr:Byte Ptr )' = "SetEntityString"
	...
	Function SetTextureString_( obj:Byte Ptr,varid:Int,cstr:Byte Ptr )' = "SetTextureString"
